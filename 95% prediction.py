        ...
        def Pred_Use_inputs(currency, ex_currency, filename, cur):
            ...
            def form(filename):
                ...
                if Historic == None:
                   ...
                   server.login("forexPrediction135@gmail.com", "mohamoudforex2002")
                   name = (cur + '/' + ex_currency)
                   msg = ('NO MATCH for graph similiar to Current Graph for: ' + name)
                   server.sendmail(
                      "forexPrediction135@gmail.com",
                      "forexPrediction135@gmail.com", 
                       msg)
                   server.quit()
                   return
                ...
                body = resist
                sender_email = "forexPrediction135@gmail.com"
                receiver_email = "forexPrediction135@gmail.com"
